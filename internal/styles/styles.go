...
var (
	...
	AdaptiveSelectedBg  = lipgloss.AdaptiveColor{Light: "#dcdcdc", Dark: "#303030"}
	...
	SelectedCmdStyle        = lipgloss.NewStyle().Foreground(AdaptivePink).Background(AdaptiveSelectedBg)
